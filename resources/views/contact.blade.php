    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                <h4 class="header-subtitle" >Sampurasun !!!</h4>
                <h1 class="header-title">Belajar Laravel</h1>
                <h6 class="header-mono" >Sareng Programer Handal Amik-YPAT Purwakarta (Bp Manarul)</h6>
                </div>
        </div>
    </header>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">0856 2494 1234</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">Amik YPAT Purwakarta</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">majuterus@gmail.com</span></h6>
                            </div>
                        </div>
